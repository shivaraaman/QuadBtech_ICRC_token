...
import { idlFactory } from './token_transfer_from_backend.did.js';
export { idlFactory } from './token_transfer_from_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TOKEN_TRANSFER_FROM_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_transfer_from_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_transfer_from_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_transfer_from_backend.did.js")._SERVICE>}
 */
export const token_transfer_from_backend = createActor(canisterId);
